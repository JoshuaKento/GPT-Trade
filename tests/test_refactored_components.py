...
from edgar.urls import (
    validate_cik, validate_accession_number, validate_document_name,
    URLBuilder, CIKValidationError, AccessionValidationError
)
...
from edgar.config_manager import EdgarConfig, ConfigManager
...
class TestEdgarClient:
    ...
    def test_client_rate_limiting(self, mock_session_class):
        ...
        config = ClientConfig(rate_limit_per_sec=10.0)  # Very fast for testing
