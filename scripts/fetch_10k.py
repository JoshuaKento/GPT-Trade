...
from edgar.urls import validate_cik, CIKValidationError, URLBuilder
...
def main() -> None:
    ...
    try:
        ...
        with EdgarClient(client_config) as client:
            ...
            doc_url = URLBuilder.document_url(cik, ten_k_filing.accession, ten_k_filing.primary_document)
